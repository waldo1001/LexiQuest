...
- Deployed `9b314d7` to Azure SWA. Live probes green: new waldo PNG hashes match local; `/api/users/public` returns the new `avatar_image_url` field (still `null` in prod for Waldo until prod seed is run per [deployment.md §1d](deployment.md)). Run: https://github.com/waldo1001/LexiQuest/actions/runs/24984788713.
